...
power_values_1 <- bpower(n1 = sample_sizes*R1, n2 = sample_sizes*(1-R1), p1 = P1, p2 =  P1B, alpha = A1)
power_values_2 <- bpower(n1 = sample_sizes*R2, n2 = sample_sizes*(1-R2), p1 = P2, p2 =  P2B, alpha = A2)
power_values_3 <- bpower(n1 = sample_sizes*R3, n2 = sample_sizes*(1-R3), p1 = P3, p2 =  P3B, alpha = A3)
power_values_4 <- bpower(n1 = sample_sizes*R4, n2 = sample_sizes*(1-R4), p1 = P4, p2 =  P4B, alpha = A4)
power_values_5 <- bpower(n1 = sample_sizes*R5, n2 = sample_sizes*(1-R5), p1 = P5, p2 =  P5B, alpha = A5)
power_values_6 <- bpower(n1 = sample_sizes*R6, n2 = sample_sizes*(1-R6), p1 = P6, p2 =  P6B, alpha = A6)
...
power_df <- data.frame(sample_size = sample_sizes, 
                       setNames(list(power_values_1), paste("prop",P1,P1B, sep="_")),
                       setNames(list(power_values_2), paste("prop",P2,P2B, sep="_")),
                       setNames(list(power_values_3), paste("prop",P3,P3B, sep="_")),
                      setNames(list(power_values_4), paste("prop",P4,P4B, sep="_")),
                      setNames(list(power_values_5), paste("prop",P5,P5B, sep="_")),
                       setNames(list(power_values_6), paste("prop",P6,P6B, sep="_"))
)
...
#  scale_color_manual(labels = c("p1=0.20, p2=0.15", "p1=0.20, p2=0.10", 
 ...
 # scale_linetype_manual(values=c("solid",   "dashed")) +
  ...
  scale_x_continuous(breaks = seq(0,input$x_range[2],50), limits = c(0,input$x_range[2])) +
  theme_bw() +
