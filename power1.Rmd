...
renderPlot({
 ...
 p <- p[complete.cases(p), ]
  ...
  ggtitle(paste0("Power (or total sample size) for ordinal catergorical data (superiority and non-inferiority)") )
...
```{r newbin input}
        ...
        d$n2 <- d$n - d$n1 
          d$power=NA
         d$power  <- bpower(n1 = d$n1, 
                                         n2 =d$n2, p1 = d$p1, p2 =  d$p2, alpha = d$alpha)  
