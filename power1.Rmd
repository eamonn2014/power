...
Three arm trial (continuous and binary) 2
===
...
```{r threearm12, eval=TRUE}
  ...
  sliderInput('x_rangepo2', 'Plot x-range', value = c(0,300),
    ...
    three.arm.v2 <- function(u0, u1, u2, n,  sigma0, sigma1, sigma2, alpha1=0.05 ,  nSims=sims , out.var=1 )
{
...
#       u1=.3
#       u2=.5
#       sigma0=sigma2=sigma1=.3
#       A=alpha=0.05
#       out.var=1
#       ss=nSims=1000
#       N=2000
# ##  
#        three.arm.v2(u0=u0, u1=u1, u2=u2, sigma0=sigma0, sigma1=sigma1, sigma2=sigma2, 
#              n=N, alpha=alpha, out.var=out.var, nSims=nSims)       
#           
#           mus=c(.9,.8,.6)
#           sds=c(.3,.3,.3) 
#                    link=1              
...
alpha=sig.level, out.var=link,  n=n)
 ...
 bvout[i,] <- three.arm.v2(u0=d$mu1[i], u1=d$mu2[i], u2=d$mu3[i], 
                            sigma0=d$sds1[i], sigma1=d$sds2[i], sigma2=d$sds3[i], 
...
# test_data_long <- melt(x, id="n",  measure.vars=c("trt1 v Ctrl", "trt2 v Ctrl", "both v Ctrl", "conjunctive", "disjunctive", 
# "at least 1") )
# 
