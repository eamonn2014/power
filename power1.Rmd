...
```{r tab1}
   ...
   #        p1_z=c("0.2,0.25,0.35,0.2,0.25,0.35")
   #        p2_z=c("0.1,0.15,0.25,0.15,0.2,0.3")
   #        alpha_z= c("0.05, 0.05,0.05, 0.05,0.05, 0.05")
   #        ro_z= c("1,1,1,1,1,1")
      #    x_range_z <- c(0,800)
       #   y_range_z <- c(0,1)
   # 
   #          A <-   (as.numeric(unlist(strsplit( alpha_z,","))))    
   #  Az<-   (as.numeric(unlist(strsplit( p1_z,","))))    
   #  Aa<-   (as.numeric(unlist(strsplit(p2_z,","))))    
   #  Ab<-   (as.numeric(unlist(strsplit( ro_z,","))))    
   #           
