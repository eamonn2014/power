...
```{r threearm1}
          ...
          splitLayout(
          textInput("mus",    div(h5(tags$span(style="color:blue", "hyp. proportions \U1D7B9 1...n"))),    
          value= ".9,.8,.7"),)
           
          splitLayout(
          textInput("sds", div(h5(tags$span(style="color:blue", "SD"))), 
...
#
#  x <- three.arm(u0=.8, u1=.6, u2=.6, sigma0=5.22, sigma1=5.22, sigma2=5.22, n=170, alpha=.05, out.var=1, nSims=1000)
  #       
  # three.arm(u0=8, u1=6, u2=6, sigma0=5.22, sigma1=5.22, sigma2=5.22, n=170, alpha=.05, out.var=2, nSims=1000)  
  #       
  #       
