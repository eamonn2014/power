...
# scale_color_manual(labels = c("p1=0.20, p2=0.15", "p1=0.20, p2=0.10", 
 ...
 # scale_linetype_manual(values=c("solid",   "dashed")) +
  ...
  # legend.key.size = unit(12, "pt"),  # legend horizontal bar length
    ...
    # legend.key = element_rect(linewidth = 15), # this is ok
         
   # legend.text = element_text(margin = margin(r = 10, unit = "pt"), size=10),
    #  legend.text = element_text(margin = margin(r = 2, unit = 'cm'), size=10),
    # 
    # legend.spacing.y = unit(0.5, 'cm'), #space under legend title
    # 
