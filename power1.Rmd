...
#------------------------------------------------------------------------------------------------------------  
          ...
          POsim <- function(P, n, beta_trt, Q) 
           ...
           # 2 Now harrell's function, collect the pvalue
           n2 <- round( N * Q )
           n1 <- N - n2 
