...
splitLayout(
          ...
          value= "0.2, 0.3, 0.4, 0.1"),)
                ...
                splitLayout(
          textInput("or", div(h5(tags$span(style="color:blue", "odds ratio"))), 
          value= "1,2"), 
                                       )
          ...
          splitLayout(
          textInput("Q",    div(h5(tags$span(style="color:blue", "ratio for unequal randomisation"))),   
          value= "0.5, 1"),)                                
...
renderPlot({
 ...
 p <- p[complete.cases(p), ]
  ...
  legendlabels <- data.frame(
   ...
   p <- p[,c(  "n" , "alpha",   "power",   "frac", "or")]
   names(p)  <-    c( "n" , "alpha",   "power",   "ratio", "variable")
  #-----------------------------------------------------------------------
